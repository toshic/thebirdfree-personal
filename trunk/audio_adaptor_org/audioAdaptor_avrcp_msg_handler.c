...
static void handleAvrcpOperation (avc_operation_id opid, bool state)
{
    ...
    {    
        ...
        {    /* Some headsets use Pause to toggle between playing and paused states */
            ...
            {
                usbHidIssueHidCommand(AppEventAvrcpPause);
            }
            else
            {
                usbHidIssueHidCommand(AppEventAvrcpPlay);
            }
        }
        ...
        {
            usbHidIssueHidCommand(AppEventAvrcpNext);
        }
        else if (opid == opid_backward)
        {
            usbHidIssueHidCommand(AppEventAvrcpPrev);
        }
        else if (opid == opid_stop)
        {
            usbHidIssueHidCommand(AppEventAvrcpStop);
        }
    }
}
    ...
    switch(current_state)
    {
        ...
        {                     
            ...
            {        
                ...
                else if( msg->status == avrcp_key_missing )
                {
