...
#define AUDIO_PLUGIN_MESSAGE_BASE	0x5e00

typedef enum
{
	AUDIO_PLUGIN_DSP_MSG = AUDIO_PLUGIN_MESSAGE_BASE,
	AUDIO_PLUGIN_MESSAGE_TOP
} AudioPluginMessageId;
