...
static const int gLedPinsUsed = 0x0003 ; 
...
static const ledEntry_t pattern_RED_BLUE_BOTH_RPT_THREE [ 6 ] = 
{
    { 0x0003 , ON  , 100  }  , 
    { 0x0003 , OFF , 100  }  , 
    { 0x0003 , ON  , 100  }  , 
...
static const led_t gLeds [ LED_NUM_PATTERNS ] = 
{
    ...
    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON_BLUE_ONE_SEC_ON_RPT } ,
    ...
    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON_BLUE_SHORT_RPT } ,
    ...
    {  { 8,  0x00 , RPT }, (ledEntry_t *) pattern_RED_REP_BLUE_ALT_RPT } ,

    {  { 8,  0x00 , OFF }, (ledEntry_t *) pattern_RED_BLUE_BOTH_RPT_FAST } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_BLUE_BOTH_RPT } ,

    {  { 6,  0x00 , RPT }, (ledEntry_t *) pattern_RED_BLUE_BOTH_RPT_THREE } ,
