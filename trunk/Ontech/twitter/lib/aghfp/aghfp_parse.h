...
struct aghfpHandleMessageFormat
{
  uint16 format;
};
struct aghfpHandleListMessage
{
  uint16 stat;
};
struct aghfpHandleListMessageText
{
  struct sequence stat;
};
struct aghfpHandleReadMessage
{
  uint16 index;
};
struct aghfpHandleSendMessage
{
...
struct aghfpHandleSelectPhonebookMemoryStorage
{
  struct sequence storage;
};
struct aghfpHandlePreferedMessageStorage
{
  struct sequence storage;
};
...
void aghfpHandleMessageFormatQuery(Task );
void aghfpHandleMessageFormat(Task , const struct aghfpHandleMessageFormat *);
void aghfpHandleListMessage(Task , const struct aghfpHandleListMessage *);
void aghfpHandleListMessageText(Task , const struct aghfpHandleListMessageText *);
...
void aghfpHandleSelectPhonebookMemoryStorage(Task , const struct aghfpHandleSelectPhonebookMemoryStorage *);
void aghfpHandlePreferedMessageStorageStatus(Task );
void aghfpHandlePreferedMessageStorageQuery(Task );
void aghfpHandlePreferedMessageStorage(Task , const struct aghfpHandlePreferedMessageStorage *);
