...
.define SRC_HEADER
   ...
   .CONST   $src.upsample_downsample.OUT_COUNTER                      13;//better to initialized to ROUT_FIELD, however 0 is okay
   .CONST   $src.upsample_downsample.RF                               14;//init to 0
   
   .CONST   $src.upsample_downsample.STRUC_SIZE                       15;
