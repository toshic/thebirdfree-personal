...
{
	return connectionAuthGetAttributeNow(ps_base, bd_addr, size_psdata, psdata);
}
...
{
	return connectionAuthGetIndexedAttributeNow(ps_base, index, size_psdata, psdata, addr);
}
