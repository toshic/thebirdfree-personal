...
/****************************************************************************/
void a2dpSignallingConnectFailure(A2DP *a2dp)
{
	if (a2dp->signal_conn.connect_then_open_media)
	{
	...
	{
		a2dpSendSignallingConnectCfm(a2dp, a2dp->clientTask, a2dp_operation_fail, 0);
	}
}
...
/****************************************************************************/
void a2dpMediaConnectFailure(A2DP *a2dp)
{
	a2dp->media_conn.media_connecting = 0;
