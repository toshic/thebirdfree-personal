...
/****************************************************************************
NAME	
	avrcpSendInformBatteryResponse

DESCRIPTION
	This function is called to send an InformBattery response.
*/
...
/****************************************************************************
NAME	
	avrcpSendInformCharSetResponse

DESCRIPTION
	This function is called to send an InformCharSet response.
*/
...
/****************************************************************************
NAME	
	sendNextGroupResponse

DESCRIPTION
	This function is called to send a NextGroup response.
*/
...
/****************************************************************************
NAME	
	sendPreviousGroupResponse

DESCRIPTION
	This function is called to send a PreviousGroup response.
*/
