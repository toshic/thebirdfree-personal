...
DESCRIPTION
	Prepare to send the next packet of fragmented data, that the CT has requested.
*/
void avrcpHandleNextContinuationPacket(AVRCP *avrcp, const AVRCP_INTERNAL_NEXT_CONTINUATION_PACKET_T *message);
